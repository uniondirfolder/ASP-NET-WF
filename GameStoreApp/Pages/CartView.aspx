<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartView.aspx.cs" Inherits="GameStoreApp.Pages.CartView" MasterPageFile="~/Pages/Store.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
        ...
        <table id="cartTable">
            ...
            <tbody>
                <asp:Repeater ID="Repeater1" ItemType="GameStoreApp.Models.CartLine"
